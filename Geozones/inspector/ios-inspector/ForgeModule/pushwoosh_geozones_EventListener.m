#import "pushwoosh_geozones_EventListener.h"

@implementation pushwoosh_geozones_EventListener
...
+ (void)applicationWillEnterForeground:(UIApplication *)application {
	...
	[[ForgeApp sharedApp] event:@"pushwoosh_geozones.resume" withParam:nil];
}
